...
//  Code content:
//  1: class BankAccount: 
//      The class contains a constructor populating: accountId, accountHolder, accountinitialDeposit.
//      The class includes: setter, getters and methods
...
class BankAccount {
  ...
  constructor(accountHolder: string, initialDeposit: number = 0) {
    // nextId populates accountid. Then, nextId increases by 1
    this.accountId = BankAccount.nextId++; 
...
export default function App() {
  ...
  return (
    <div style={{ padding: "2rem", fontFamily: "monospace", maxWidth: "600px" }}>
      ...
      <div style={{backgroundColor:'lightgray', paddingTop:'1px', paddingLeft:'10px', paddingRight:'10px', paddingBottom:'1px', width:'100%', borderRadius:'5px'}}>
        <h3 style={{textAlign:'center', margin:'0px'}}>History</h3>
        <pre ref={logContainerRef} style={{ background: "#1e1e1e", color: "lightgreen", padding: "1rem", borderRadius: "5px", height: "300px", overflowY: "auto", textAlign:'left', marginTop:'0px' }}>
          {logs.join("\n")}
        </pre>
      </div>
      <br/>
      <div style={{backgroundColor:'#452296', color:'white', padding:'5px', width:'100%', borderRadius:'5px'}}>
        Click: 
        <a style={{color:'wheat'}} href="https://github.com/juanduranc/TypeScript-Bank-Accounts-App/tree/main" 
        target="_blank">Github: Juan's Source Code</a>
      </div>
